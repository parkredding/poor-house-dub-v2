...
ExecStart=$USER_HOME/poor-house-dub-v2-venv/bin/python3 $USER_HOME/poor-house-dub-v2/main.py --audio-backend alsa --audio-device 0 --buffer-size 2048 --sample-rate 48000
Restart=on-failure
RestartSec=5
