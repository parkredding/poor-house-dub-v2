...
class MomentarySwitch:
    ...
    def _poll_loop(self):
        ...
        while self.running:
            ...
            time.sleep(0.002)  # Faster poll for better responsiveness
...
class ControlSurface:
    ...
    def start(self):
        ...
        self.synth.set_pitch_envelope('up')  # Pre-calculated lookup table - fast!
        ...
        print(f"Pitch Envelope: UP (pre-calculated lookup table, 2 octaves)")
